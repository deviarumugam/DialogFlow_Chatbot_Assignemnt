...
def processRequest(req):
    ...
    if intent == 'course_selection':
        ...
        email_sender.send_email_to_support(cust_name=cust_name, cust_contact=cust_contact, cust_email=cust_email,
                                           course_name=course_name, body=email_message_support)
        fulfillmentText = "We have sent the course syllabus and other relevant details to you via email. An " \
                          "email has been sent to the Support Team with your contact information, you'll be " \
